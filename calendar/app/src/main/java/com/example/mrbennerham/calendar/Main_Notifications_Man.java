...
public class Main_Notifications_Man extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.notifications_man);
        // enable logging
        ...
        calendar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(Main_Notifications_Man.this);
        ...
        if(bundle != null){
            ...
            try {
                model.setResult(bundle.getString("Result"));
            } catch (NullPointerException e) {

            }

            if (idsting == null) {
                new AsyncInsertCalendar_Notifications_Man(this,  model).execute();
            } else{
    ...
    void showGooglePlayServicesAvailabilityErrorDialog(final int connectionStatusCode) {
        runOnUiThread(new Runnable() {
            public void run() {
                Dialog dialog = GooglePlayServicesUtil.getErrorDialog(connectionStatusCode, Main_Notifications_Man.this, REQUEST_GOOGLE_PLAY_SERVICES);
                dialog.show();
            }
        });
    }
...
//                }
    ...
    private void startAddOrEditCalendarActivity(CalendarInfo calendarInfo) {
        Intent intent = new Intent(this, AddOrEditCalendarActivity_Notifications_Man.class);
