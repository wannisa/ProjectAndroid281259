...
public class FeedArticleActivity_Man extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_feed_article_man);
    ...
    public class AsyncHttpTask extends AsyncTask<String, Void, Integer> {
        ...
        protected void onPostExecute(Integer result) {
            progressBar.setVisibility(View.GONE);
            if (result == 1) {
                adapter = new FeedArticleRecyclerAdapter(FeedArticleActivity_Man.this, feedsList);
