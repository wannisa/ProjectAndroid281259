...
public class AddOrEditCalendarActivity_Notifications_Man extends Activity implements View.OnClickListener {
    private String id;
...
//            return;
//        }
        Intent t = new Intent(AddOrEditCalendarActivity_Notifications_Man.this, Main_Notifications_Man.class);
        if (id != null) {
            t.putExtra("id", id);
        }
        ...
        Toast.makeText(this, "ัวันที่เริ่มแจ้งเตือนการกินยา " + textdate + "วันที่สิ้นสุดการแจ้งเตือนการกินยา " + textdateend + "เวลา " + texttimer, Toast.LENGTH_LONG).show();
//        Toast.makeText(this, "วันที่เริ่มต้นประจำเดือน "+textdate  , Toast.LENGTH_LONG).show();
    ...
    public void onCancel(View view) {
        ...
        Intent intent = new Intent(AddOrEditCalendarActivity_Notifications_Man.this, Main_Notifications_Man.class);
