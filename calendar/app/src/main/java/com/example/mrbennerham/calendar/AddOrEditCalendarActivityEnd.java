 ...
 */
public class AddOrEditCalendarActivityEnd extends Activity implements View.OnClickListener{
    private String id;
...
//        setContentView(R.layout.addcalendar);
        setContentView(R.layout.calendar_insert_event_end);
...
//                return;
//            }
        Intent t = new Intent(AddOrEditCalendarActivityEnd.this, MainActivity.class);
        if (id != null) {
            t.putExtra("id", id);
        }
...
//                Toast.makeText(this, "วันที่เริ่มต้นประจำเดือน "+textdate + "วันที่สิ้นสุดประจำเดือน " +textdateend , Toast.LENGTH_LONG).show();
        Toast.makeText(this, "วันที่สิ้นสุดประจำเดือน "+textdateend  , Toast.LENGTH_LONG).show();
        startActivity(t);
    ...
    public void onCancel(View view) {
        ...
        Intent intent = new Intent(AddOrEditCalendarActivityEnd.this, MainActivity.class);
